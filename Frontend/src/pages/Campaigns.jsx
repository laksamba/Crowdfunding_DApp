    ...
    <div className='flex flex-col gap-3 justify-center items-center pt-18'>
      <div className='flex gap-4'>
       ...
       <div className='text-center'>
         <h1 className='md:text-7xl text-4xl font-caveat font-bold pb-2 block text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-blue-600'>Campaigns</h1>
